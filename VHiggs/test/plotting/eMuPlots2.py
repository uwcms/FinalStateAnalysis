...
def saveplot(filename):
    ...
    canvas.Update()
    canvas.Print(os.path.join("plots", 'eMu2', filename + filetype))
    canvas.SetLogy(True)
    canvas.Update()
    canvas.Print(os.path.join("plots", 'eMu2',
...
regions = {
    'os_fr_region' : ['kine', 'os_em', 'e_iso', 'hps_pass'],
    #'os_fr_region_ttbar' : ['kine', 'os_em', 'e_iso', 'hps_pass', 'ttbar_enriched'],
    'os_fr_region_ttbar' : ['kine', 'os_et', 'e_iso', 'hps_pass', 'ttbar_enriched'],
    'ss_fr_region' : ['kine', 'ss_em', 'hps_pass', 'e_iso'],
    'ss_fr_super_region' : ['kine', 'ss_em', 'hps_pass', 'e_iso', 'mu_veto', 'b_veto', 'ht_cut', 'vtx_cut'],
