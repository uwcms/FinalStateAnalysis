...
skips =['EM', 'MuPt5', 'TauPlusX', '2011B_PromptReco_v1_b', 'SingleMu', 'MuEG', 'DoubleMu', '2011B', 'MuHad']
...
def saveplot(filename):
    ...
    canvas.Update()
    canvas.Print(os.path.join("plots", 'doubleE', filename + filetype))
    canvas.SetLogy(True)
    canvas.Update()
    canvas.Print(os.path.join("plots", 'doubleE',
