...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer(
    ...
    OutputFileName = cms.string("fit_results.root"),
    ...
    # defines all the discrete variables of the probes available in the
    # input tree and intended for use in the efficiency calculations
    Categories = cms.PSet(
        mcTrue = cms.vstring("MC true", "dummy[true=1,false=0]"),
        passingPFIDTight = cms.vstring("passingPFIDTight", "dummy[pass=1,fail=0]")
    ),

    # defines all the PDFs that will be available for the efficiency
    # calculations; uses RooFit's "factory" syntax;
    # each pdf needs to define "signal", "backgroundPass", "backgroundFail"
    # pdfs, "efficiency[0.9,0,1]" and "signalFractionInPassing[0.9]" are
