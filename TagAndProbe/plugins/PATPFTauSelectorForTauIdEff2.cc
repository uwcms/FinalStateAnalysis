...
class PATPFTauSelectorForTauIdEff2 : public edm::EDFilter
{
 public:

  explicit PATPFTauSelectorForTauIdEff2(const edm::ParameterSet&);
  virtual ~PATPFTauSelectorForTauIdEff2();
...
PATPFTauSelectorForTauIdEff2::PATPFTauSelectorForTauIdEff2(const edm::ParameterSet& cfg)
  : trackQualityCuts_(0),
    muonSelection_(0),
...
PATPFTauSelectorForTauIdEff2::~PATPFTauSelectorForTauIdEff2()
{
...
bool PATPFTauSelectorForTauIdEff2::filter(edm::Event& evt, const edm::EventSetup& es)
{
  if ( verbosity_ ) {
    std::cout << "<PATPFTauSelectorForTauIdEff2::filter>:" << std::endl;
...
DEFINE_FWK_MODULE(PATPFTauSelectorForTauIdEff2);
