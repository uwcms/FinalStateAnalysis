...
class PATQuadFinalStateBuilderT : public edm::stream::EDProducer<> {
  public:
  ...
  private:
    ...
    const edm::EDGetTokenT<edm::View<typename FinalState::daughter4_type> > leg4Src_;
...
PATQuadFinalStateBuilderT<FinalState>::PATQuadFinalStateBuilderT(
  ...
  leg4Src_(consumes<edm::View<typename FinalState::daughter4_type> >(pset.getParameter<edm::InputTag>("leg4Src"))),
