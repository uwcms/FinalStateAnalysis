...
class MiniAODJetIdEmbedder2017 : public edm::EDProducer {
  public:
    MiniAODJetIdEmbedder2017(const edm::ParameterSet& pset);
    virtual ~MiniAODJetIdEmbedder2017(){}
    void produce(edm::Event& evt, const edm::EventSetup& es);
  private:
    edm::EDGetTokenT<edm::View<pat::Jet> > srcToken_;
};

MiniAODJetIdEmbedder2017::MiniAODJetIdEmbedder2017(const edm::ParameterSet& pset) {
  srcToken_ = consumes<edm::View<pat::Jet> >(pset.getParameter<edm::InputTag>("src"));
  produces<pat::JetCollection>();
}

void MiniAODJetIdEmbedder2017::produce(edm::Event& evt, const edm::EventSetup& es) {
...
DEFINE_FWK_MODULE(MiniAODJetIdEmbedder2017);
