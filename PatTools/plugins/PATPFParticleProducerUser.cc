//
// $Id: PATPFParticleProducerUser.cc,v 1.6 2012/05/26 10:42:53 gpetrucc Exp $
//

#include "FinalStateAnalysis/PatTools/plugins/PATPFParticleProducerUser.h"
...
PATPFParticleProducerUser::~PATPFParticleProducerUser() {
}


void PATPFParticleProducerUser::produce(edm::Event & iEvent,
...
void
PATPFParticleProducerUser::fetchCandidateCollection( edm::Handle<edm::View<reco::PFCandidate> >& c,
...
DEFINE_FWK_MODULE(PATPFParticleProducerUser);
