...
#        fs_daughter_inputs['jets'] = 'selectedPatJetsRematched'
    ...
    if options.useMiniAOD:
        ...
        nonTrigMVAWeights = [
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EB1_5_oldscenario2phys14_BDT.weights.xml',
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EB2_5_oldscenario2phys14_BDT.weights.xml',
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EE_5_oldscenario2phys14_BDT.weights.xml',
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EB1_10_oldscenario2phys14_BDT.weights.xml',
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EB2_10_oldscenario2phys14_BDT.weights.xml',
            'EgammaAnalysis/ElectronTools/data/PHYS/EIDmva_EE_10_oldscenario2phys14_BDT.weights.xml',
            ]
