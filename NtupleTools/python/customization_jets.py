...
def preJets(process, jSrc, vSrc, mSrc, eSrc, **kwargs):
    ...
    if doFullJESUnc :
        ...
        if runningLocal : fName = "../../NtupleTools/data/Summer16_23Sep2016AllV3_DATA_UncertaintySources_AK4PFchs.txt" # recommended by JetMET
        else :
            cmsswversion=os.environ['CMSSW_VERSION']
            fName = "{0}/src/FinalStateAnalysis/NtupleTools/data/Summer16_23Sep2016AllV3_DATA_UncertaintySources_AK4PFchs.txt".format(cmsswversion)
