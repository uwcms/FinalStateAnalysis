...
def preMETFromJES(process, jSrc, vSrc, metSrc, metUpSrc, metDownSrc, mSrc, eSrc, **kwargs):
    ...
    if True :
        ...
        if runningLocal : fName = "../../NtupleTools/data/RegroupedV2_Summer16_07Aug2017_V11_MC_UncertaintySources_AK4PFchs.txt" # recommended by JetMET
        else :
            cmsswversion=os.environ['CMSSW_VERSION']
            fName = "{0}/src/FinalStateAnalysis/NtupleTools/data/RegroupedV2_Summer16_07Aug2017_V11_MC_UncertaintySources_AK4PFchs.txt".format(cmsswversion)
