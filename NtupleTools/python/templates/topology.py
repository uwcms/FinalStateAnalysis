...
extraJet = PSet(
    ...
    #objectEta = '? evt.jets.size()>{object_idx} & {object}.userFloat(\'idLoose\') & {object}.userFloat(\'cleanJet\') & {object}.pt()>20 & abs({object}.eta())<2.5? {object}.eta() : -999',
    #objectPhi = '? evt.jets.size()>{object_idx} & {object}.userFloat(\'idLoose\') & {object}.userFloat(\'cleanJet\') & {object}.pt()>20 & abs({object}.eta())<2.5? {object}.phi() : -999',
    ...
    #aobjectBJetCISV = '? evt.jets.size()>{object_idx} ? {object}.bDiscriminator(\'pfCombinedInclusiveSecondaryVertexV2BJetTags\') : -999',
)
