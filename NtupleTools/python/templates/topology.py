...
vbf = PSet(
  # If nJets < 2, none of these other branches are valid
   ...
   vbfJetVeto30 = 'vbfVariables("pt > 30 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).jets30',
   ...
   vbfJetVeto20_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).jets20',
   vbfMVA_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).mva',
   vbfMass_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).mass',
   vbfDeta_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).deta',
   vbfDphi_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).dphi',
   vbfj1eta_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).eta1',
   vbfj2eta_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).eta2',
   vbfVispt_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).c2',
   vbfHrap_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).hrapidity',
   vbfDijetrap_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).dijetrapidity',
   vbfDphihj_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).dphihj',
   vbfDphihjnomet_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).dphihj_nomet',
   vbfj1pt_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).pt1',
   vbfj2pt_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).pt2',
   vbfdijetpt_JetEnDown =  'vbfVariables("userCand(\'jes-\').pt() >20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5", 0.5).dijetpt',
