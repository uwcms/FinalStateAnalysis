...
shiftedMet = PSet(
    ...
    type1_pfMet_shiftedPt_JetjesAbsoluteMPFBiasUp             = 'evt.metShift("pfmet","pt","jesAbsoluteMPFBias+")',
    ...
    type1_pfMet_shiftedPt_JetPileUpRefUp             = 'evt.metShift("pfmet","pt","jesPileUpRef+")',
    type1_pfMet_shiftedPt_JetPileUpRefDown             = 'evt.metShift("pfmet","pt","jesPileUpRef-")',
    type1_pfMet_shiftedPt_JetPileUpBalUp             = 'evt.metShift("pfmet","pt","jesPileUpBal+")',
    type1_pfMet_shiftedPt_JetPileUpBalDown             = 'evt.metShift("pfmet","pt","jesPileUpBal-")',
    type1_pfMet_shiftedPt_JetPileUpFSRUp             = 'evt.metShift("pfmet","pt","jesPileUpFSR+")',
    type1_pfMet_shiftedPt_JetPileUpFSRDown             = 'evt.metShift("pfmet","pt","jesPileUpFSR-")',
    ...
    type1_pfMet_shiftedPhi_JetjesAbsoluteMPFBiasUp             = 'evt.metShift("pfmet","phi","jesAbsoluteMPFBias+")',
    ...
    type1_pfMet_shiftedPhi_JetPileUpRefUp             = 'evt.metShift("pfmet","phi","jesPileUpRef+")',
    type1_pfMet_shiftedPhi_JetPileUpRefDown             = 'evt.metShift("pfmet","phi","jesPileUpRef-")',
    type1_pfMet_shiftedPhi_JetPileUpBalUp             = 'evt.metShift("pfmet","phi","jesPileUpBal+")',
    type1_pfMet_shiftedPhi_JetPileUpBalDown             = 'evt.metShift("pfmet","phi","jesPileUpBal-")',
    type1_pfMet_shiftedPhi_JetPileUpFSRUp             = 'evt.metShift("pfmet","phi","jesPileUpFSR+")',
    type1_pfMet_shiftedPhi_JetPileUpFSRDown             = 'evt.metShift("pfmet","phi","jesPileUpFSR-")',
