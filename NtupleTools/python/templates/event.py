...
shiftedMet = PSet(
    ...
    #full JES                                                                                                                                                                                                                                                                   
    type1_pfMet_shiftedPt_AbsoluteFlavMapUp     = 'evt.metShift("pfmet","pt","jesAbsoluteFlavMap+")',
    type1_pfMet_shiftedPt_AbsoluteFlavMapDown   = 'evt.metShift("pfmet","pt","jesAbsoluteFlavMap-")',
    type1_pfMet_shiftedPt_AbsoluteMPFBiasUp     = 'evt.metShift("pfmet","pt","jesAbsoluteMPFBias+")',
    type1_pfMet_shiftedPt_AbsoluteMPFBiasDown   = 'evt.metShift("pfmet","pt","jesAbsoluteMPFBias-")',
    ...
    type1_pfMet_shiftedPhi_AbsoluteFlavMapUp     = 'evt.metShift("pfmet","phi","jesAbsoluteFlavMap+")',                                                                                                                                                        
    type1_pfMet_shiftedPhi_AbsoluteFlavMapDown   = 'evt.metShift("pfmet","phi","jesAbsoluteFlavMap-")',                                                                                                                                                        
    type1_pfMet_shiftedPhi_AbsoluteMPFBiasUp     = 'evt.metShift("pfmet","phi","jesAbsoluteMPFBias+")',                                                                                                                                                        
    type1_pfMet_shiftedPhi_AbsoluteMPFBiasDown   = 'evt.metShift("pfmet","phi","jesAbsoluteMPFBias-")',                                                                                                                                                        
