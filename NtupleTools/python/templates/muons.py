...
# ID and isolation
id = PSet(
    objectCutBasedIdLoose = '{object}.CutBasedIdLoose()',
    objectCutBasedIdMedium = '{object}.CutBasedIdMedium()',
    objectCutBasedIdMediumPrompt = '{object}.CutBasedIdMediumPrompt()',
    objectCutBasedIdTight = '{object}.CutBasedIdTight()',
    objectCutBasedIdGlobalHighPt = '{object}.CutBasedIdGlobalHighPt()',
    objectCutBasedIdTrkHighPt = '{object}.CutBasedIdTrkHighPt()',
    objectPFIsoVeryLoose = '{object}.PFIsoVeryLoose()',
    objectPFIsoLoose = '{object}.PFIsoLoose()',
    objectPFIsoMedium = '{object}.PFIsoMedium()',
    objectPFIsoTight = '{object}.PFIsoTight()',
    objectPFIsoVeryTight = '{object}.PFIsoVeryTight()',
    objectTkIsoLoose = '{object}.TkIsoLoose()',
    objectTkIsoTight = '{object}.TkIsoTight()',
    objectSoftCutBasedId = '{object}.SoftCutBasedId()',
    objectSoftMvaId = '{object}.SoftMvaId()',
    objectMvaLoose = '{object}.MvaLoose()',
    objectMvaMedium = '{object}.MvaMedium()',
    objectMvaTight = '{object}.MvaTight()',
    objectMiniIsoLoose = '{object}.MiniIsoLoose()',
    objectMiniIsoMedium = '{object}.MiniIsoMedium()',
    objectMiniIsoTight = '{object}.MiniIsoTight()',
    objectMiniIsoVeryTight = '{object}.MiniIsoVeryTight()',
