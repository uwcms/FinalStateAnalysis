...
parameters = {
    ...
    'eventVariables' : PSet(
        ...
        jb1pt_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(0)',
        jb1eta_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(1)',
        jb1phi_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(2)',
        ...
        jb2pt_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(10)',
        jb2eta_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(11)',
        jb2phi_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(12)',
        jb2hadronflavor_2016 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.6321", 0.5).at(16)',

        jb1pt_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(0)',
        jb1eta_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(1)',
        jb1phi_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(2)',
        ...
        jb2pt_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(10)',
        jb2eta_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(11)',
        jb2phi_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(12)',
        jb2hadronflavor_2017 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4941", 0.5).at(16)',

        jb1pt_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(0)',
        jb1eta_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(1)',
        jb1phi_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(2)',
        ...
        jb2pt_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(10)',
        jb2eta_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(11)',
        jb2phi_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BsvAll\')  > 0.4184", 0.5).at(12)',
        jb2hadronflavor_2018 = 'jetVariables("pt > 20 & userFloat(\'idTight\') > 0.5 & abs(eta) < 2.4 & bDiscriminator(\'pfDeepCSVDiscriminatorsJetTags:BvsAll\') > 0.4184", 0.5).at(16)',
