...
parameters = {
    ...
    'electronVariables' : PSet(
        ...
        objectMatchesEle24Tau20L1Filter      = 'matchToHLTFilter({object_idx}, "hltEle24WPLooseL1SingleIsoEG22erGsfTrackIsoFilter", 0.5)',
    ...
    'muonVariables' : PSet(
        ...
        objectMatchesMu19Tau20sL1Filter      = 'matchToHLTFilter({object_idx}, "hltL1fL1sSingleMu18erIorSingleMu20erL1Filtered0", 0.5)',
        ...
        objectIsoMu22Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu20L1Filtered0", 0.5)',
        objectIsoTkMu22Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu20L1Filtered0", 0.5)',
        objectIsoMu22eta2p1Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sSingleMu20erL1Filtered0", 0.5)',
        objectIsoTkMu22eta2p1Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu20erL1Filtered0", 0.5)',
        objectIsoMu24Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu22L1Filtered0", 0.5)',
        objectIsoMu24eta2p1Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu22erL1Filtered0", 0.5)',
        objectIsoTkMu24Filter = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu22L1Filtered0", 0.5)',
    ...
    'tauVariables' : PSet(
        ...
        objectMatchesMu19Tau20Filter      = 'matchToHLTFilter({object_idx}, "hltL1fL1sMu18erTauJet20erL1Filtered0", 0.5)',
        objectMatchesMu19Tau20sL1Filter      = 'matchToHLTFilter({object_idx}, "hltL1fL1sSingleMu18erIorSingleMu20erL1Filtered0", 0.5)',
        objectMatchesMu21Tau20sL1Filter      = 'matchToHLTFilter({object_idx}, "hltPFTau20TrackLooseIsoAgainstMuon", 0.5)',
        ...
        objectMatchesEle24Tau20L1Path      = r'matchToHLTPath({object_idx}, "HLT_Ele24_eta2p1_WPLoose_Gsf_LooseIsoPFTau20_SingleL1_v\\d+", 0.5)',
        objectMatchesEle24Tau30Path      = r'matchToHLTPath({object_idx}, "HLT_Ele24_eta2p1_WPLoose_Gsf_LooseIsoPFTau30_v\\d+", 0.5)',
        objectMatchesEle24Tau20Filter      = 'matchToHLTFilter({object_idx}, "hltTauJet5", 0.5)',
        objectMatchesEle24Tau20L1Filter      = 'matchToHLTFilter({object_idx}, "hltTauJet5", 0.5)',
        objectMatchesEle24Tau30Filter      = 'matchToHLTFilter({object_idx}, "hltTauJet5", 0.5)',
