...
parameters = {
    ...
    'electronVariables' : PSet(
        ...
        objectMatchesEle24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30Path= r'matchToHLTPath({object_idx}, "HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30_eta2p1_CrossL1_v\\d+", 0.5)',
    ...
    'muonVariables' : PSet(
        ...
        objectMatchesIsoMu20_eta2p1_LooseChargedIsoPFTau27Path= r'matchToHLTPath({object_idx}, "HLT_IsoMu20_eta2p1_LooseChargedIsoPFTau27_eta2p1_CrossL1_v\\d+", 0.5)',
