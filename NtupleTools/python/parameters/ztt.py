...
parameters = {
    ...
    #    jetVeto20RecoilZTT = 'vetoJets(0.5, "pt > 20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
        ...
        jetVeto20ZTT_JERUp = 'vetoJets(0.5, "userCand(\'jer+\').pt > 20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
        jetVeto20ZTT_JERDown = 'vetoJets(0.5, "userCand(\'jer-\').pt > 20 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
    ...
    #    jetVeto30RecoilZTT = 'vetoJets(0.5, "pt > 30 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
        ...
        jetVeto30ZTT_JERUp = 'vetoJets(0.5, "userCand(\'jer+\').pt > 30 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
        jetVeto30ZTT_JERDown = 'vetoJets(0.5, "userCand(\'jer-\').pt > 30 & abs(eta) < 4.7 & userFloat(\'idLoose\') > 0.5").size()',
