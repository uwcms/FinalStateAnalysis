...
vetos = PSet(
    muVetoPt5 = 'extras("extMuons", "pt > 5 & abs(eta) < 2.1").size()',
    muGlbIsoVetoPt10 = 'extras("extMuons", "isGlobalMuon & isTrackerMuon & pt > 10 & abs(eta) < 2.1 & (chargedHadronIso + max(photonIso + neutralHadronIso - 0.5*userIso(0), 0))/pt < 0.25").size()',
