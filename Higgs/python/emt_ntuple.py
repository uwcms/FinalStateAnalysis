        ...
        final = cms.PSet(
            ...
            plot = cms.PSet(
                ...
                ntuple = cms.PSet(
                    ...
                    ElecPt = cms.string('{electron}.pt'),
                    TauPt = cms.string('{tau}.pt'),
                    MuAbsEta = cms.string('abs({muon}.eta)'),
                    ElecAbsEta = cms.string('abs({electron}.eta)'),
                    TauAbsEta = cms.string('abs({tau}.eta)'),
                )
            ),
        )
    )
